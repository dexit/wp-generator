...
const PostType = () => {
    ...
    const add = () => setPostTypes([...postTypes, { name: '', singular: '', plural: '', public: true, has_archive: true, show_in_rest: true, icon: 'dashicons-admin-post' }]);
                    ...
                    <div className="row g-2">
                        ...
                        <div className="col-md-3">
                            <div className="form-check form-switch mt-4">
                                ...
                                <label className="form-check-label" htmlFor={`pt-public-${i}`}>Public</label>
                            </div>
                        </div>
                        <div className="col-md-3">
                            <div className="form-check form-switch mt-4">
                                ...
                                <label className="form-check-label" htmlFor={`pt-rest-${i}`}>REST API</label>
                            </div>
                        </div>
